...
> **NOTE (Quantum-information への適用について)**: 本 `features.md` は
> 兄弟プロジェクトの [`quarto-textbook-template`](https://github.com/yama662607/quarto-textbook-template)
> から取り込んだものです。**Quantum-information リポには機能ショーケース partial
> (`_05`〜`_08`) を当面統合していません** — Preskill / Watrous の翻訳本体に
> 集中するため。動く live demo を見たい場合はテンプレの公開サイト
> <https://yama662607.github.io/quarto-textbook-template/> を参照してください。
> このファイルは「将来 QI でも機能を試したくなったときの索引」として保持しています。
